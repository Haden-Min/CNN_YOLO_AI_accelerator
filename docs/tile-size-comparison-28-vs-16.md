...
| 지표 | 28×28 | 16×16 | 해석 |
| --- | ---: | ---: | --- |
| 타일 완료 cycle | 5701 | 1729 | 16×16이 69.7% 짧음 |
| 타일 latency @100 MHz | 57.01 µs | 17.29 µs | 단일 요청 응답은 16×16 우세 |
| cycle/output | 8.433 | 8.821 | 28×28이 4.4% 효율적 |
...
| 추정 core/AXI cycle | 1,459,456 | 1,556,100 |
| 추정 시간 @100 MHz | 14.595 ms | 15.561 ms |

16×16은 28×28보다 타일 명령이 3.52배 많고 입력 전송량이 약 14.8% 많다. 순수 RTL
cycle 추정도 약 6.6% 느리며, 실제 PS/DMA software overhead를 포함하면 차이는 더
커질 가능성이 높다.
